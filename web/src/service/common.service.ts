...
import {Assert, isNotNullOrUndefined, randomNumber, UnknownProperty} from '@yunzhi/utils';
...
export class CommonService {
  ...
  //     if (tip) {
  //       if (Swal.getFooter() && Swal.getFooter()!.querySelector('b')) {
  //         Swal.getFooter()!.querySelector('b')!.textContent = tip;
  //       }
  //     }
  //   }, 1500);
  //
